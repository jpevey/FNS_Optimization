...
# Stage 2 743462457235
# Stage 3 87654356787654
# Stage 3 expanded fast flux tiers, 97654356787654
random.seed(22345678901234567)
...
# If false, an average between the parents is taken and a delta is applied to each one.
...
def build_mcnp_model(individual):
    ...
    if job_zone_type == "10inch":
        ...
        if void_vol_split >= 52.8265:
            void_vol_split = 52.8264
